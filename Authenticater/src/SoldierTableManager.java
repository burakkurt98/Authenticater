...
public class SoldierTableManager implements TableManager{	
	@Override
	public String getValues(String userName) {
		String[] values = new String[3];
		ResultSet res = null;
		try {
		String sqlData = "select * from asker where id='" + userName + "'";
		res = name(sqlData);
	...
	public String insertInTo(PersonalInformation personalInformation) {
		return "INSERT INTO asker (name,surname,id,password) VALUES ('" + personalInformation.getName() + "','" + personalInformation.getSurname() + "','" + personalInformation.getUsername() 
